...
esto seria agregar un proyecto de salud tipo diaro personal de nuestro cuerpo

#### solamente toma rehistro e lo qe pasa

es decir lo unico qe hacemos es de 5 minutos o menos

conclusiones de los  minutos

#### es un diario de tu regeneracion

algo que vas a agradecer luego

conslusines de porque se hace

Conslusines de crear un proyecto

Conslusines de un paso facil de hacer

## AHORA AGREGAMOS UNA HABILIDAD NUEVA

Si ahora agreamos en treello una hbailidad nueva

### FUERZA FISICA: TODO SOBRE EJERCICIOS

aca viene todo aquel tecnica de ejercico qe t guste practicas
